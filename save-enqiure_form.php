...
if($err == ''){ 
          ...
          $sql = "insert into enquiries (name, email,country_code, phone, country,state,city,company_name, address, grade, size, quantity, created_at) values ('".$name."', '".$email."','".$country_code."', '".$phone."','".$country."','".$state."','".$city."', '".$company_name."', '".$address."', '".$grade."', '".$size."', '".$quantity."', '".$created_at."');";
          $conn->query($sql);
			...
			$mail_message = "<html>
			   ...
			   <body>
				  <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
					 ...
					 <tr>
						<td class='style2'>Hi admin!  New enquiry has been recived from ".WEBSITE_NAME."</td>
					 </tr>
					 <tr>
						<td>&nbsp;</td>
					 </tr>
		   ...
		   if($_SERVER['HTTP_HOST'] != 'localhost'){
			...
			$subject =  'Hi admin!  New enquiry has been recived from '.WEBSITE_NAME;
