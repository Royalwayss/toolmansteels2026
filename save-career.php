...
if($err == ''){ 
           ...
           if(!empty($_FILES["resume"]["name"])){
			   ...
			   if($FileType == 'docx' || $FileType == 'doc' || $FileType == 'pdf'){
				   $file_name = time().''.rand(10,100).'-'.$_FILES["resume"]["name"];
				   $file_path = $target_dir.''.$file_name;
				  
				   $tmp_name = $_FILES["resume"]["tmp_name"];
				   if ( move_uploaded_file($tmp_name, $file_path)) {
					  $resume_file_path = BASEURL.''.$file_path;
			...
			$mail_message = "<html>
			   ...
			   <body>
				  <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
					 ...
					 <tr>
						<td class='style2'>Hi admin!  New career enquiry has been recived from ".WEBSITE_NAME."</td>
					 </tr>
					 <tr>
						<td>&nbsp;</td>
					 </tr>
						...
						<td align='left' valign='middle'>
						   <table width='98%' border='0' align='right' cellpadding='5' cellspacing='5' style='background-color:#F5F5F5'>
							 ...
							 <tr>
							  ...
							  <tr>
								 <td width='30%' align='left' valign='top' class='style2'>Age</td>
								 <td width='5%' align='left' valign='top' class='style2'>:</td>
								 <td width='65%' align='left' valign='top' class='style3'>".$age."</td>
							  </tr>
							  <tr>
								 <td width='30%' align='left' valign='top' class='style2'>Education</td>
								 <td width='5%' align='left' valign='top' class='style2'>:</td>
								 <td width='65%' align='left' valign='top' class='style3'>".$education."</td>
							  </tr>
							  <tr>
							   ...
							   <tr>
								 ...
								 <td width='5%' align='left' valign='top' class='style2'>:</td>
								 <td width='65%' align='left' valign='top' class='style3'>".$experience."</td>
							  </tr>
							   <tr>
							  ...
							  if($resume_file != ''){
								 ...
								 <td width='5%' align='left' valign='top' class='style2'>:</td>
								 <td width='65%' align='left' valign='top' class='style3'><a download target='black' href='".$resume_file_path."'>".$resume_file." </a></td>
							      </tr>";
							  }
		   ...
		   $sql = "INSERT INTO `careers` (`name`, `email`, country_code, `phone`, `age`, `country`, `state`, `city`, `experience`, `education`,resume,`message`, `created_at`) VALUES ('".$name."', '".$email."', '".$country_code."','".$phone."', '".$age."', '".$country."', '".$state."', '".$city."', '".$experience."','".$education."','".$resume_file."','".$message."','".$created_at."')";
		   $conn->query($sql);

          
			if($_SERVER['HTTP_HOST'] != 'localhost'){
				$recipient = ADMIN_MAIL;
				$subject =  'Hi admin!  New career enquiry has been recived from '.WEBSITE_NAME;
