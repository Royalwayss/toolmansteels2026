...
if($err == ''){ 
          ...
          $sql = "insert into product_enquiries (name, email, phone, company_name, address, product_name, page_link, grade, size, quantity, created_at) values ('".$name."', '".$email."', '".$phone."', '".$company_name."', '".$address."', '".$product_name."', '".$page_link."', '".$grade."', '".$size."', '".$quantity."', '".$created_at."');";
          $conn->query($sql);
