...
<html>
   <head>
      ...
      <?Php
         $id= $_GET['id'];
         $sql = "SELECT *  FROM product_enquiries where id='".$_GET['id']."'"; 
         $result =mysqli_query($conn, $sql);
         $row = mysqli_fetch_assoc($result); 
         if($row['view_status'] == '0'){
            $update_query = "UPDATE product_enquiries SET view_status = '1' WHERE id = ".$row['id']; 
      ...
      <div class="wrapper content-wrapper">
         ...
         <div class="page-heading">
            <h1 class="page-title"> Product Enquiry View</h1>
                  ...
                  <div class="ibox-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 ">
                           ...
                           <p style="margin-left:10px"> <?php echo $row['company_name']; ?> </p>
                        </div>
						<div class="col-md-6 ">
						...
						<div class="col-md-6 ">
						 ...
						 <div class="col-md-6 ">
                           ...
                           <p style="margin-left:10px"> <?php echo $row['address']; ?> </p>
                        </div>
						 <div class="col-md-6 ">
                           <b><label>Product Name:</label></b><br> 
                           <p style="margin-left:10px"> <a style="color: #007bff;" target="_black" href="<?php echo $row['page_link']; ?>"><?php echo $row['product_name']; ?></a> </p>
                        </div>
                        <div class="col-md-6 ">
                           <b><label>Grade:</label></b><br> 
                           <p style="margin-left:10px"> <?php echo $row['grade']; ?> </p>
                        </div>
						 <div class="col-md-6 ">
                        ...
                        <div class="col-md-6 ">
                           ...
                           <p style="margin-left:10px"> <?php echo $row['quantity']; ?> </p>
                        </div>
